...
def uploadDataToEnv (r, p):
  ...
  c3UsageStats.logAPIUploadBatchJob(p, c3TypeToBatchJobMapping)
  ...
  c3UsageStats.logAPIUploadImportErrors(p, c3TypeToBatchJobMapping)
